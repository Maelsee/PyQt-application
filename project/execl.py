...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        # self.tableWidget.setGeometry(QtCore.QRect(0, 60, 1000, 600))
    ...
    def openfile(self):
        ...
        path_openfile_name = '/home/dang/Nutstore Files/我的坚果云/dataVisualization/datavisual/账户交易明细表.xls'
